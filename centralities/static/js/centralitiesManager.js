...
(function(window) {
    ...
    function generateResultTable(resultDataJSON, sortElem, sort_up) {
        ...
        tableHTML += '<button type="button" class="btn btn-default" onclick="saveResultsAsCSV()">Get results as CSV</button></br>';
        tableHTML += '<button type="button" class="btn btn-default" onclick="saveResultsAsTex()">Get results as TEX</button>';
